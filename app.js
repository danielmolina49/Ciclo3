...
document.write("Información que se muestra en la pagina a través del java scrip");
document.write("<p>Mi segundo parrafo traído a través del javascirpt en esta página</p>");
